          ...
          <form id="form-matakuliah" method="post" class="m-3">
            <div class="form-group row mb-2">
              ...
              <div class="col-8">
                ...
                <span id="input-kurikulumHelpBlock" class="form-text text-muted">Kurikulum Mata Kuliah dalam Mata Kuliahtansi</span>
              </div>
            </div>
            <div class="form-group row mb-2">
              ...
              <div class="col-8">
                ...
                <span id="input-prodiHelpBlock" class="form-text text-muted">Kurikulum Mata Kuliah dalam Mata Kuliahtansi</span>
              </div>
            </div>
            <div class="form-group row mb-2">
